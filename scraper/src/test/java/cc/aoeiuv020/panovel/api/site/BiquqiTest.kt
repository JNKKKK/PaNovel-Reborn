...
class BiquqiTest {
    ...
    @Test
    fun testDetail() {
        val detail = context.getNovelDetail("79/79838")
        assertEquals("别来无恙", detail.novel.name)
        assertEquals("北南", detail.novel.author)
    ...
    @Test
    fun testChapters() {
        val chapters = context.getNovelChaptersAsc("79/79838")
    ...
    @Test
    fun testContent() {
        val content = context.getNovelContent("79/79838/1091103")
