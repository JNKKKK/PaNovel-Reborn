...
class BpshuTest {
    ...
    @Test
    fun testDetail() {
        val detail = context.getNovelDetail("143")
    ...
    @Test
    fun testChapters() {
        val chapters = context.getNovelChaptersAsc("143")
    ...
    @Test
    fun testContent() {
        val content = context.getNovelContent("143/155832")
