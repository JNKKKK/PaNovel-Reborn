...
class BqqugeTest {
    ...
    @Test
    fun testDetail() {
        val detail = context.getNovelDetail("531")
    ...
    @Test
    fun testChapters() {
        val chapters = context.getNovelChaptersAsc("531")
    ...
    @Test
    fun testContent() {
        val content = context.getNovelContent("531/406542")
