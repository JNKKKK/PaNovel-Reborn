...
class IxdzsTest {
    ...
    @Test
    fun testDetail() {
        val detail = context.getNovelDetail("38804")
        assertEquals("斗破蒼穹", detail.novel.name)
        assertEquals("天蠶土豆", detail.novel.author)
    ...
    @Test
    fun testChapters() {
        val chapters = context.getNovelChaptersAsc("38804")
    ...
    @Test
    fun testContent() {
        val content = context.getNovelContent("38804/p1")
