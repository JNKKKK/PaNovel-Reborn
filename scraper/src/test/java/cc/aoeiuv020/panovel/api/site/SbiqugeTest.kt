...
class SbiqugeTest {
    ...
    @Test
    fun testDetail() {
        val detail = context.getNovelDetail("0_143")
        assertEquals("斗破苍穹", detail.novel.name)
        assertEquals("天蚕土豆", detail.novel.author)
    ...
    @Test
    fun testChapters() {
        val chapters = context.getNovelChaptersAsc("0_143")
    ...
    @Test
    fun testContent() {
        val content = context.getNovelContent("0_143/155832")
