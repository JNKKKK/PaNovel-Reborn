...
class SuduguTest {
    ...
    @Test
    fun testDetail() {
        val detail = context.getNovelDetail("448")
    ...
    @Test
    fun testChapters() {
        val chapters = context.getNovelChaptersAsc("448")
    ...
    @Test
    fun testContent() {
        val content = context.getNovelContent("448/642594")
